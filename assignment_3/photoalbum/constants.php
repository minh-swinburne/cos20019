...
define('STUDENT_NAME', 'Nguyen Thi Thanh Minh');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104169617');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Monday 01:00PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'photoalbum-s3bucket');
